...
class Model(nn.Module):
    ...
    def __init__(self, config):
        ...
        for param in self.bert.parameters():
            param.requires_grad = True  # True:参数进行微调
    ...
    def forward(self, x):
        ...
        # BertModel forward : def forward(self, input_ids, token_type_ids=None, attention_mask=None, output_all_encoded_layers=True):
        _, pooled = self.bert(context, attention_mask=mask, output_all_encoded_layers=True)  # shaoe[128,768]
