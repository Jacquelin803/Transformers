...
from transformerArc.pyitcast.Transformer import TransformerModel
...
if __name__ == '__main__':
    ...
    # step02 构建用于模型输入的批次化数据 (结果中每列都是句子)
    ...
    def batchify(data, bsz):
        ...
        # 也就是data的列数是等于bsz的值的.
        # print("data.shape before view : ",data.shape)
        # print(data[0:30,:])
        ...
        for batch, i in enumerate(range(0, train_data.size(0) - 1, bptt)):
            ...
            if batch % log_interval == 0 and batch > 0:
                ...
                print('| epoch {:3d} | {:5d}/{:5d} batches | '
                    ...
                    i, batch, len(train_data) // bptt, scheduler.get_lr()[0],
